...
class Pipeline:
    def __init__(self):
        ...
        self.id = "llmguard_prompt_injection_filter_pipeline_with_russian_test"
        self.name = "LLMGuard Prompt Injection Filter with russian test"
    ...
    async def on_startup(self):
        ...
        self.model = PromptInjection(threshold=0.8, match_type=MatchType.FULL, model="bert-base-multilingual-cased", use_onnx=False)
        pass
